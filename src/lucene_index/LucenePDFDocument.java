...
public final class LucenePDFDocument
{
    ...
    private void addContent( Document document, InputStream is, String documentLocation ) throws IOException
    {
        ...
        try
        {
            ...
            String creationDate = getDateFromCalendar(info.getCreationDate());
            
            if( info != null ) 
            {
                addTextField( document, "Author", info.getAuthor() );
                addTextField( document, "CreationDate", creationDate );
    ...
    private String getDateFromCalendar(Calendar cal) {
        ...
        String hh = Integer.toString(calendar.get(Calendar.HOUR));
        String mn = Integer.toString(calendar.get(Calendar.MINUTE));
       // int sec = calendar.get(Calendar.SECOND);
        
        myDate =  dd +"/" + mm +"/" + yyyy + " " + hh + ":" +mn;
